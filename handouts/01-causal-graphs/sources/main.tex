...
\scalebox{0.90}{\includegraphics{fig-graph-with-cycle}}
\end{figure}
...
\scalebox{0.90}{\includegraphics{fig-graph-shorthand-unobserved-common-cause}}
\end{figure}
...
\scalebox{0.90}{\includegraphics{fig-graph-basic-causal-relationships}}
\end{figure}
