...
We showcase they very basics of the tooling needed for the course.

.. toctree::
   :maxdepth: 1

   tools-data-science/notebook.ipynb
...
* `Introduction to structural microeconometrics <https://nbviewer.jupyter.org/github/OpenSourceEconomics/respy-lectures/blob/master/lectures/introduction/notebook.ipynb>`_
